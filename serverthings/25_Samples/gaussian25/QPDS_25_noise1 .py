...
plt.savefig('./gaussian25/signals_25_noise1/'+str(power)+"_"+str(base)+"_"+"SignalsPics.pdf", dpi=150)
...
plt.savefig('./gaussian25/pre_dgms_25_noise1/'+str(power)+"_"+str(base)+"_"+"Pre-pdgmspdf", dpi=150)
...
plt.savefig('./gaussian25/post_dgms_25_noise1/'+str(power)+"_"+ str(base)+"_"+str(Av_QPDS)+"_PDiagrams.pdf", dpi=150)
...
df1.to_csv('./gaussian25/tables_25_noise1/'+str(power)+"_"+ str(base)+'_power_base_QPDS_.csv')
