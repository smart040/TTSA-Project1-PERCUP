...
plt.savefig('./gaussian50/signals_50_noise1/'+str(power)+"_"+str(base)+"_"+"SignalsPics.pdf", dpi=150)
...
plt.savefig('./gaussian50/pre_dgms_50_noise1/'+str(power)+"_"+str(base)+"_"+"Pre-pdgmspdf", dpi=150)
...
plt.savefig('./gaussian50/post_dgms_50_noise1/'+str(power)+"_"+ str(base)+"_"+str(Av_QPDS)+"_PDiagrams.pdf", dpi=150)
...
df1.to_csv('./gaussian50/tables_50_noise1/'+str(power)+"_"+ str(base)+'_power_base_QPDS_.csv')
