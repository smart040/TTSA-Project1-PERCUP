...
def noisy_funct(t):
    return  2*np.sin(t) + 1.8*np.sin(exp*t) + np.random.laplace(size=size, scale=spread)
...
#plt.show()
plt.savefig('./signals_12_noise3/'+str(power)+"_"+str(base)+"_"+"SignalsPics.pdf", dpi=150)
...
#plt.show()
plt.savefig('./pre_dgms_12_noise3/'+str(power)+"_"+str(base)+"_"+"Pre-pdgms_noise3", dpi=150)
...
plt.savefig('./pre_dgms_12_noise3/'+str(power)+"_"+str(base)+"_"+"Pre-pdgmsaver_noise3", dpi=150)
#plt.show()
...
#plt.show()
    ...
    dgm_w_cup = plt.savefig('./post_dgms_12_noise3/'+str(power)+"_"+ str(base)+"_"+str(Av_QPDS)+"_PDiagrams.pdf", dpi=150)
    #plt.show()
...
df1.to_csv('./tables_12_noise3/'+str(power)+"_"+ str(base)+'_power_base_QPDS_.csv')
