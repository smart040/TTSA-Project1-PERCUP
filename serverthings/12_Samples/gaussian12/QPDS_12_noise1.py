...
plt.savefig('./gaussian12/signals_12_noise1/'+str(power)+"_"+str(base)+"_"+"SignalsPics.pdf", dpi=150)
...
plt.savefig('./gaussian12/pre_dgms_12_noise1/'+str(power)+"_"+str(base)+"_"+"Pre-pdgmspdf", dpi=150)
...
plt.savefig('./gaussian12/post_dgms_12_noise1/'+str(power)+"_"+ str(base)+"_"+str(Av_QPDS)+"_PDiagrams.pdf", dpi=150)
...
df1.to_csv('./gaussian12/tables_12_noise1/'+str(power)+"_"+ str(base)+'_power_base_QPDS_.csv')
