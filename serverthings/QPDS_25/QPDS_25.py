...
plt.plot(t, funct(t))
#plt.show()
plt.savefig('./signals_25/'+str(power)+"_"+str(base)+"_"+"SignalsPics.pdf", dpi=150)
...
plt.savefig('./pre_dgms_25/'+str(power)+"_"+str(base)+"_"+"Pre-pdgmspdf", dpi=150)
#plt.show()
...
plt.savefig('./pre_dgms_25/'+str(power)+"_"+str(base)+"_"+"Pre-pdgmsaver", dpi=150)
#plt.show()
...
#plt.show()
    ...
    dgm_w_cup = plt.savefig('./post_dgms_25/'+str(power)+"_"+ str(base)+"_"+str(Av_QPDS)+"_PDiagrams.pdf", dpi=150)
    #plt.show()
...
df1.to_csv('./tables_25/'+str(power)+"_"+ str(base)+'_power_base_QPDS_.csv')
